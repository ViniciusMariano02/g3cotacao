...
export const Products = ({nomeDoUsuario , idDaLoja}) => {
    ...
    useEffect(() => {
        async function fetchData (){
            const response = await fetch ("http://8b38091fc43d.sn.mynetname.net:2000/cotacao/fornecedor/7"); 
    ...
    return(
        ...
        <div className='geral'>
            ...
            <div className='container'>
                ...
                <p className="marca"> {nomeDoUsuario} <button className="exit" onClick={onChangeLogin}>Sair</button> </p>
            </div>
